...
import githubdp from "@/public/githubdp.jpeg";
...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hi, I'm Daniyal</span> I'm a{" "}
        <span className="font-bold">software engineer</span> at {" "}
        <a
          href="https://sunbonn.com/"
        ...
        . I build and maintain full-stack systems from modern frontends to
        event-driven backends and infrastructure — with a focus on performance,
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/daniyal-ahmed25/"
          target="_blank"
        >
